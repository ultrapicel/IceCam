...
public class MainActivity extends Activity {
    ...
    private void renderUi() {
        ...
        TextView hint = muted("Development build · v9.6.5 auto-pipeline · Camera2 immediate single-preview Surface renderer + image renderer experiment"); hint.setPadding(dp(14),0,dp(14),dp(6)); root.addView(hint);
    ...
    private void dashboard(){
        ...
        n.addView(muted("v9.6.5 markers: AutoPipelineJson, Camera2SurfaceShadowJson, SurfaceClassifierJson, Camera2SurfaceRenderJson, provider bridge OK, renderer active, no crash"));
    }
