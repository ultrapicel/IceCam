# IceCam v9.6.0 — Low Level Deep Probe

`v9.6.0-first-real-camera1-injection` pivots IceCam toward a system-level camera-provider/HAL route. It is still passive diagnostics only: no fake frames, no Surface replacement, no provider replacement yet.
...
- `IceCam-app-v9.6.0.apk`
- `IceCam-root-module-v9.6.0.zip`
- `IceCam-source-snapshot-v9.6.0.zip`
...
6. Send `icecam_debug_v9.6.0_<timestamp>.tar.gz`.
