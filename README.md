# IceCam v9.6.1 — Low Level Deep Probe

`v9.6.1-auto-pipeline-camera2-surface-shadow` pivots IceCam toward a system-level camera-provider/HAL route. It is still passive diagnostics only: no fake frames, no Surface replacement, no provider replacement yet.
...
- `IceCam-app-v9.6.1.apk`
- `IceCam-root-module-v9.6.1.zip`
- `IceCam-source-snapshot-v9.6.1.zip`
...
6. Send `icecam_debug_v9.6.1_<timestamp>.tar.gz`.
