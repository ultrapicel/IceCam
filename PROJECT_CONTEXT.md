...
Current version: v9.6.1-auto-pipeline-camera2-surface-shadow.
...
v9.6.1 does not inject frames. It adds root diagnostics to determine which low-level route is viable on the test device and across Android 12-15:
