...
Current version: v9.5.1-low-level-deep-probe.
...
v9.5.1 does not inject frames. It adds root diagnostics to determine which low-level route is viable on the test device and across Android 12-15:
