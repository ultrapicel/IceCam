...
Current version: v9.6.0-first-real-camera1-injection.
...
v9.6.0 does not inject frames. It adds root diagnostics to determine which low-level route is viable on the test device and across Android 12-15:
